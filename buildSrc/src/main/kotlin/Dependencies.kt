...
object CommonLibs {
  const val android_gradle_plugin = "com.android.tools.build:gradle:7.0.0-beta05"
...
object AndroidXSwipeRefreshLayout{
...
object Chuck {
  ...
  const val chuck = "com.readystatesoftware.chuck:library:$version"
  const val chuck_no_op = "com.readystatesoftware.chuck:library-no-op:$version"
}
...
object AndroidXMultiDex {
  private const val version = "2.0.1"

  const val multi_dex = "androidx.multidex:multidex:$version"
}
