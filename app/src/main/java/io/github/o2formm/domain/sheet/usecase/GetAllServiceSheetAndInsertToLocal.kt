 ...
 **/
class GetAllServiceSheetAndInsertToLocal constructor(private val serviceSheetRepository: ServiceSheetRepository) :
  CoroutineUseCase<Unit, Unit>() {

  override suspend fun provide(input: Unit) {
     serviceSheetRepository.getAllServicesAndInsertToLocal()
  }
}